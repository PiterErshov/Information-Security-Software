...
namespace Lab1_Gamming_Srammbling.CryptoClass
{
    ...
    {
        public static BigInteger RandomBigIntInRange(BigInteger min, BigInteger max)
        {
        ...
        public static BigInteger RandomBigIntFromZero(RandomNumberGenerator rng, BigInteger max)
        {
            BigInteger value;
        ...
        public static bool MillerRabinTest(BigInteger N, BigInteger D)
        {
        ...
        public static BigInteger GetLargeRandomPrime()
        {
        ...
        public static byte[] Encrypt(byte[] M, RSAKeyClass EncryptionKey) => BigInteger.ModPow(new BigInteger(M), EncryptionKey.Key, EncryptionKey.N).ToByteArray();
