using Lab2_BCP_Feistel_network.CryptoClass;
using Lab2_BCP_Feistel_network.Models;
using Lab2_BCP_Feistel_network.Utilitiets;
using System;
using System.Collections;
using System.Windows;

namespace Lab2_BCP_Feistel_network
{
        ...
        private void UpdateKey_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (KeyFormarFlag == "Scrambler")
            {
                if (TextFormat.Text == "Text")
                {
                    ...
                    var b = ScammblerClass.LFSR_one(Convert.ToUInt32(bb), ScramFormat.SelectedIndex);
